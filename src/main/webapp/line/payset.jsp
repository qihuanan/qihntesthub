                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form_id" role="form" action="${sysPath}/line/payset" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>设置内容： 7天1分钱 30天2分钱 365天3分钱<br>
                                                eg:<br>
                                                7天体验卡，5元,7-500-7天体验卡，5元;<br>
                                                30天畅玩卡，10元,30-1000-30天畅玩卡，10元;<br>
                                                90天尊享卡，20元,365-2000-90天尊享卡，20元;<br>
                                                注意格式<br>
                                                7天体验卡，5元,7-500  其中 7天体验卡，5元（注意卡后面是中文逗号）  是显示的radio 的内容， 后面是英文逗号<br>
                                                7-500  中的 7  代表时间 有效期7天  500 代表支付的金额，分 是单位，500 就是5块<br>
                                                目前只支持3个选项，可在这三个选项中任意更改里面 中文文字，数字，建议 里面的 逗号、分号不要改了<br>
                                                后面重复的部分是微信支付时候显示的内容。<br>
                                                3个选项，用分号分割， 一个选项里面的内容有 英文逗号分割，中间的 时间，钱和微信支付时候的文字用横岗分割<br>
