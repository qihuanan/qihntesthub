                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form_id" role="form" action="${sysPath}/goods/merge" method="post" >
                                        ...
                                        <div class="form-group">
                                            <label>price </label>
                                            <input class="form-control" name="price" type="text" value="${goods.price}"  />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <c:if test="${!empty goods.skupicture }">
                                                <img  src="${sysPath}/download?filename=${goods.skupicture}" width="50px" height="50px">
                                            </c:if>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="skupicture" name="skupicture" type="text" value="${goods.skupicture}" />
                                        </div>
