                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" >
                            <div style="position: absolute;z-index: 100;margin-right: 40px; top: 300px;float: right;left: 70%;">
                                ...
                                <a href="${sysPath}/goods/mergeUI">添加添加</a><br><br>

                            </div>
                            <form action="${sysPath}/goods/list" method="post">
                                <div class="table-responsive" >
                                    ...
                                    <div id='description' style="display: block;">
                                        <div>update: ${lastupdate.gid} -- last: ${lastid.gid} --
                                            runflag: ${runflag} -- updateflag: ${updateflag} -- ${forestupdate}
                                    ...
                                    <table class="table table-striped table-bordered table-hover" style="width: 99%">
                                        ...
                                        <c:forEach var="obj" items="${list }" >
                                            <tr>
                                                ...
                                                <td>
                                                    <br><br>
                                                    <a href="${sysPath}//goods/mergeUI?id=${obj.id }">编辑</a>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <a href="${sysPath}//goods/delete?id=${obj.id }">删除</a><br>
                                                        ${obj.id }
                                                </td>
                                            </tr>
                                        </c:forEach>
