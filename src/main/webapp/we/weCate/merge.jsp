                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form_id" role="form" action="${sysPath}/weCate/merge" method="post">
                                        <input type="hidden" name="id" value="${weCate.id}" />

                                        <div class="form-group">
                                            <label>名称 </label>
                                            <input class="form-control" name="name" type="text"  value="${weCate.name}"  />
                                        </div>

                                        <div class="form-group">
                                            <label>描述 </label>
                                            <textarea class="form-control" name="remark">${weCate.remark}</textarea>
                                        </div>
