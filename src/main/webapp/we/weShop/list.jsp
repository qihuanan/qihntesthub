                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="${sysPath}/weShop/list" method="post">
                                <div class="table-responsive">
                                    <div class="row" style="width: 99%">
                                        <div class="col-sm-6" style="margin-bottom: 5px;">&nbsp;&nbsp;
                                            S: <input type="text" name="name" value="${weShop.name}">
                                            <input type="submit" value="查询"></input>&nbsp;
                                            <a href="${sysPath}/weShop/mergeUI"><input type="button" value="添加"></input></a>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" style="width: 99%">
                                        ...
                                        <c:forEach var="obj" items="${list }">
                                            <tr>
                                                ...
                                                <td > ${obj.user.name } </td>
                                                <td>
                                                    <a href="${sysPath}//weShop/mergeUI?id=${obj.id }">编辑</a>
                                                    <br><br>

                                                    <a href="${sysPath}//weShop/delete?id=${obj.id }">删除</a>
