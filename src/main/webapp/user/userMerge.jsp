                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form_id" role="form" action="${sysPath}/user/editDone" method="post" >

                                        id:<input  name="id" type="text" value="${user.id}" /><br>


                                        gid:<input name="gid" type="text" value="${user.gid}" /><br>
                                        ...
                                        age:<input  name="age" type="text" value="${user.age}" /><br>
                                        nice_name:<input  name="nice_name" type="text" value="${user.nice_name}" /><br>
