...
public class XcxUtil {
    ...
    private static Log logger = LogFactory.getLog(XcxUtil.class);
        ...
        public static BufferedImage createSharePoster(BufferedImage background, BufferedImage poster,
            ...
            try {
                ...
                // 画头像
                if (null != avatar) {
                    g.drawImage(XcxUtil.roundImage(avatar, avatar.getWidth(), avatar.getHeight(), 360).getScaledInstance(45*2, 45*2, Image.SCALE_FAST), 25*2, 603*2, null);
                }
                // 画二维码
                if (null != qr) {
    ...
    public static void main(String[] args) {
        try {
            BufferedImage bg = ImageIO.read(new File("E:\\temp\\basebg.png"));
            ...
            ImageIO.write(img, "jpg", new File("E:\\temp\\result.jpg"));
