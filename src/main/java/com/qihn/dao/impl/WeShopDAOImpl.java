...
@Repository("weShopDAO")
public class WeShopDAOImpl extends BaseDaoImpl<WeShop> implements WeShopDAO {

    @Override
    public Map<String, Object> buildHQL(WeShop entity) {
    ...
    public Long countByProperties(WeShop entity) {
        ...
        String hqlStr = "select count(*) from WeShop c where 1=1 " + hql.toString();
    ...
    public List<WeShop> findByProperties(WeShop entity, PageInfo pageInfo, Integer number, String orderby, String upDown) {
        ...
        String hqlStr = " from WeShop c where 1=1 " + hql.toString();
    ...
    public WeShop findByProperties(WeShop entity) {
        ...
        Map<String, Object> params = (Map<String, Object>) returnMap.get("params");
        String hqlStr = " from WeShop c where 1=1 " + hql.toString();
        List<WeShop> tempResult = this.find(hqlStr, params, null, null);
