...
@Repository("weCateDAO")
public class WeCateDAOImpl extends BaseDaoImpl<WeCate> implements WeCateDAO {

    @Override
    public Map<String, Object> buildHQL(WeCate entity) {
    ...
    public Long countByProperties(WeCate entity) {
        ...
        String hqlStr = "select count(*) from WeCate c where 1=1 " + hql.toString();
    ...
    public List<WeCate> findByProperties(WeCate entity, PageInfo pageInfo, Integer number, String orderby, String upDown) {
        ...
        String hqlStr = " from WeCate c where 1=1 " + hql.toString();
    ...
    public WeCate findByProperties(WeCate entity) {
        ...
        Map<String, Object> params = (Map<String, Object>) returnMap.get("params");
        String hqlStr = " from WeCate c where 1=1 " + hql.toString();
        List<WeCate> tempResult = this.find(hqlStr, params, null, null);
