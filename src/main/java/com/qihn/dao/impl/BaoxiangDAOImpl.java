...
@Repository("baoxiangDAO")
public class BaoxiangDAOImpl extends BaseDaoImpl<Baoxiang> implements BaoxiangDAO {

    @Override
    public Map<String, Object> buildHQL(Baoxiang entity) {
    ...
    public Long countByProperties(Baoxiang entity) {
        ...
        String hqlStr = "select count(*) from Baoxiang c where 1=1 " + hql.toString();
    ...
    public List<Baoxiang> findByProperties(Baoxiang entity, PageInfo pageInfo, Integer number, String orderby, String upDown) {
        ...
        String hqlStr = " from Baoxiang c where 1=1 " + hql.toString();
    ...
    public Baoxiang findByProperties(Baoxiang entity) {
        ...
        Map<String, Object> params = (Map<String, Object>) returnMap.get("params");
        String hqlStr = " from Baoxiang c where 1=1 " + hql.toString();
        List<Baoxiang> tempResult = this.find(hqlStr, params, null, null);
